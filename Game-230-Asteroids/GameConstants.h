...
const float Asteroid_Medium_Radius = 35;
const float Asteroid_Small_Radius = 10;
const int Asteroid_Minimum_Speed = 1;
const int Asteroid_Maximum_Speed = 4;
const int Asteroid_Minimum_Angular_Velocity = 2;
const int Asteroid_Maximum_Angular_Velocity = 10;
...
const int Maximum_Spawn_Asteroid_Number = 40;
