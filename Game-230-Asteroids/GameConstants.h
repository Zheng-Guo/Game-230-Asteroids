...
const int Refresh_Frequency = 500;
...
const float Spaceship_Flame_Width = 40;
const float Spaceship_Flame_Height = 20;
const char Spaceship_Texture[] = "textures/VF31J.png";
const float Spaceship_Thrust = 0.005;
const float Spaceship_Full_Speed = 0.8;
const float Spaceship_Angular_Speed = -0.5;
