...
const int Asteroid_Split_Frame_X = 2;
const int Asteroid_Split_Frame_Y = 0;
...
const int Enemy_Spaceship_Spawn_Time = 40*Refresh_Frequency;
const int Enemy_Spaceship_Spawn_Time_Margin = 30*Refresh_Frequency;
